...
CREATE TABLE IF NOT EXISTS `tbcanton` (
  ...
  FOREIGN KEY (`tbprovinciaid`) REFERENCES `tbprovincia`(`tbprovinciaid`)
);
...
CREATE TABLE IF NOT EXISTS `tbdistrito` (
  ...
  FOREIGN KEY (`tbcantonid`) REFERENCES `tbcanton`(`tbcantonid`)
);

-- PROVINCIAS
INSERT INTO `tbprovincia` (`tbprovinciaid`, `tbprovincianombre`) VALUES
(1, 'San José'),
(2, 'Alajuela'),
(3, 'Cartago'),
(4, 'Heredia'),
...
-- CANTONES
INSERT INTO `tbcanton` (`tbcantonid`, `tbprovinciaid`, `tbcantonnombre`) VALUES
(101, 1, 'San José'),
(102, 1, 'Escazú'),
(103, 1, 'Desamparados'),
(104, 1, 'Puriscal'),
...
-- DISTRITOS
INSERT INTO `tbdistrito` (`tbdistritoid`, `tbcantonid`, `tbdistritonombre`) VALUES
(10101, 101, 'Carmen'),
(10102, 101, 'Merced'),
(10103, 101, 'Hospital'),
(10104, 101, 'Catedral'),

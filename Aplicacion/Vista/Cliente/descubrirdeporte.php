...
<head>
    ...
    <title>UnaMatch - Descubre tu deporte</title>
...
<body class="cuerpoCliente">
    ...
    <main>
        <div class="juego-descubrir" id="juegoDeporte">

            <div class="juego-barra">
                <span class="juego-categoria">Deporte</span>
            ...
            <div class="juego-tarjeta-holder">
                ...
                <div class="juego-vacio d-none" id="juegoVacio">
                    <p class="text-secondary mb-0">No hay opciones de deporte disponibles por ahora.</p>
            ...
            <div id="resultadoJuego" class="juego-resultado d-none mt-4">
                <h2 class="h4 mb-1">Tu perfil de deporte</h2>
    ...
    <script>
        window.CONFIG_JUEGO = {
            apiUrl: 'apideporte.php',
            idCampo: 'deporteId',
            nombreOpcion: 'deporte'
        };
    </script>
